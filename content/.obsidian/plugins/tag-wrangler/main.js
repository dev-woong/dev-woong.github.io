...
var Jn = Object.getPrototypeOf, Yn = Object.prototype.hasOwnProperty;
var Gn = (s, e, t) =>
  e in s
...
var Qt = Ce((ar, Ms) => {
  ...
  var Hn = (s) => [function (e) {
    ...
    _s = (s, ...e) => {
      ...
      let t = (...r) => _s(s, ...e, ...r), n = s.length - e.length - 1;
      return Hn(t)[n] || t;
    };
  Ms.exports = _s;
  function Xn(s) {
...
var ct = Ce((Pe) => {
  ...
  Pe.progress = (s, e, t) => {
    ...
    `,
      ...
      { ok: o, dialog: a } = r,
      l = o();
    return R(a, ["cancel"]).map((c) => {
      c.focus();
    }),
      Object.assign(r, {
        setProgress(c) {
          let [f] = R(a, ["progress"]), [u] = R(a, ["counter"]);
  ...
  function lt(s, e, t, n, i) {
    let r = Xt(),
      ...
      a = ["cancel", "close", "ok"],
      l = new Promise((u, h) => {
        let p = i && i.cancel === !1, g = () => {}, m = () => h(Error());
        r(u), o(p ? g : m);
      }),
      c = oi(s, e, t, n),
      f = si("div", {
    ...
    return f.addEventListener("keydown", ni(f, r(), o())),
  ...
  function li(s, e, t, n) {
    ...
    switch (r) {
      ...
      case i.TAB:
        ...
        break;
      default:
        ["left", "right", "up", "down"].filter((c) => r === i[c.toUpperCase()])
          .forEach(() => {
            fi(s, l);
          });
        break;
...
var Vs = Yt(ct()),
  _e = class {
    constructor(e, t) {
      this.progress = (0, Vs.progress)(e, t),
        this.progress.catch((n) => {
          this.aborted = !0,
            n && (n.constructor !== Error || n.message !== "") &&
            console.error(n);
        }),
    ...
    set message(e) {
      let t = this.dialog.querySelector(".content-area").childNodes[0]
        .textContent = e;
    }
    get message() {
...
var Js = require("obsidian"), Ys = Yt(ct());
...
var ut = Symbol.for("yaml.alias"),
  ...
  B = Symbol.for("yaml.node.type"),
  V = (s) => !!s && typeof s == "object" && s[B] === ut,
  Se = (s) => !!s && typeof s == "object" && s[B] === ht,
  D = (s) => !!s && typeof s == "object" && s[B] === U,
  O = (s) => !!s && typeof s == "object" && s[B] === ts,
  v = (s) => !!s && typeof s == "object" && s[B] === q,
  J = (s) => !!s && typeof s == "object" && s[B] === ne;
function T(s) {
...
function Y(s, e) {
  typeof e == "object" && (e.Collection || e.Node || e.Value) &&
  (e = Object.assign(
...
function ke(s, e, t, n) {
  ...
  if (
    typeof t == "function"
      ...
      : V(e) && t.Alias && (i = t.Alias(s, e, n)), E(i) || O(i)
  ) {
    let r = n[n.length - 1];
    if (T(r)) r.items[s] = i;
  ...
  C = class {
    ...
    tagString(e) {
      for (let [t, n] of Object.entries(this.tags)) {
        if (e.startsWith(n)) {
          return t + yi(e.substring(n.length));
        }
      }
      return e[0] === "!" ? e : `!<${e}>`;
    }
...
function pt(s) {
  if (/[\x00-\x19\s,[\]{}]/.test(s)) {
    let t = `Anchor must not contain whitespace or control characters: ${
      JSON.stringify(s)
    }`;
    throw new Error(t);
  }
...
var ie = class extends ce {
  ...
  toJSON(e, t) {
    ...
    let { anchors: n, doc: i, maxAliasCount: r } = t, o = this.resolve(i);
    if (!o) {
      let l =
...
function mt(s, e, t) {
  if (V(e)) {
    let n = e.resolve(s), i = t && n && t.get(n);
    ...
    let n = mt(s, e.key, t), i = mt(s, e.value, t);
    return Math.max(n, i);
  }
  return 1;
}
...
function wi(s, e, t) {
  if (e) {
    let n = t.filter((r) => r.tag === e), i = n.find((r) => !r.format) || n[0];
...
function re(s, e, t) {
  ...
  if (O(s)) {
    let p = (i = (n = t.schema[U]).createNode) === null || i === void 0
      ? void 0
      : i.call(n, t.schema, null, t);
    return p.items.push(s), p;
  }
  (s instanceof String || s instanceof Number || s instanceof Boolean ||
    typeof BigInt == "function" && s instanceof BigInt) && (s = s.valueOf());
  let {
  ...
  oe = class extends ce {
    ...
    hasAllNullValues(e) {
      return this.items.every((t) => {
        ...
        let n = t.value;
        return n == null ||
          e && v(n) && n.value == null && !n.commentBefore && !n.comment &&
            !n.tag;
      });
    }
    hasIn(e) {
...
` + z(t, e)
    : (s.endsWith(" ") ? "" : " ") + t;
var is = "flow", gt = "block", xe = "quoted";
function je(
  s,
  e,
  t = "flow",
...
`, l += 2;
  ...
  return o = a ? o + t.slice(a) : t, n ? o : je(o, r, xe, bt(e));
}
function rs(s, e) {
  if (
    e.options.singleQuote === !1 || e.implicitKey && s.includes(`
`) ||
    /[ \t]\n|\n[ \t]/.test(s)
  ) return De(s, e);
  let t = e.indent || (wt(s) ? "  " : ""),
...
function qe(s, e) {
  let { singleQuote: t } = e.options, n;
  if (t === !1) n = De;
  else {
    let i = s.includes('"'), r = s.includes("'");
...
function ki(s, e, t, n) {
  ...
  if (
    ...
    return a || c || r.indexOf(`
`) === -1
      ? qe(r, e)
      : yt(s, e, t, n);
  }
  if (
    !a && !c && i !== S.PLAIN && r.indexOf(`
`) !== -1
  ) return yt(s, e, t, n);
...
${l}`,
  ...
  if (o) {
    let u = (g) => {
        var m;
        return g.default && g.tag !== "tag:yaml.org,2002:str" &&
...
function Q(s, e, t, n) {
  ...
  if (V(s)) {
    ...
    e.resolvedAliases
      ...
      : e.resolvedAliases = new Set([s]), s = s.resolve(e.doc);
  }
  let r, o = E(s) ? s : e.doc.createNode(s, { onTagObj: (c) => r = c });
  r || (r = Ni(e.doc.schema.tags, o));
  let a = vi(o, r, e);
  a.length > 0 && (e.indentAtStart = (e.indentAtStart || 0) + a.length + 1);
  let l = typeof r.stringify == "function"
    ? r.stringify(o, e, t, n)
    : v(o)
    ? ae(o, e, t, n)
    : o.toString(e, t, n);
...
${z(A, t.indent)}`;
  ...
  t.implicitKey = !1,
    ...
    m = !1,
    !f && l.length >= 2 && !t.inFlow && !p && J(e) && !e.flow && !e.tag &&
    !e.anchor && (t.indent = t.indent.substr(2));
  let N = !1, b = Q(e, t, () => N = !0, () => m = !0), k = " ";
  return y || h
    ? k = b === "" && !t.inFlow ? y : `${y}
${t.indent}`
    : !p && T(e)
...
function ve(s, e, t) {
  let n = re(s, void 0, t), i = re(e, void 0, t);
  return new L(n, i);
}
var L = class {
  constructor(e, t = null) {
    Object.defineProperty(this, B, { value: ts }), this.key = e, this.value = t;
  }
  clone(e) {
...
function Ei(
  ...
  let { indent: l, options: { commentString: c } } = t,
...
function Ti(
  ...
  let { indent: o, indentStep: a, options: { commentString: l } } = t;
  i += a;
  ...
  for (let d = 0; d < e.length; ++d) {
    ...
    d < e.length - 1 && (N += ","),
      w && (N += G(N, i, l(w))),
      !f && (h.length > u || N.includes(`
`)) && (f = !0),
      h.push(N),
      u = h.length;
  }
  let p, { start: g, end: m } = n;
  if (h.length === 0) p = g + m;
  else if (
    f ||
    (f = h.reduce((y, w) =>
      y + w.length + 2, 2) > oe.maxFlowStringSingleLineLength), f
  ) {
    p = g;
    for (let d of h) {
      p += d
...
var $ = class extends oe {
  ...
  get(e, t) {
    let n = fe(this.items, e), i = n && n.value;
  ...
  toString(e, t, n) {
    ...
    return !e.allNullValues && this.hasAllNullValues(!1) &&
...
function Li(s, e, t) {
  ...
  return typeof s.sortMapEntries == "function" &&
    r.items.sort(s.sortMapEntries),
    r;
}
var W = {
  collection: "map",
...
function Ot(s) {
  let e = v(s) ? s.value : s;
  return e && typeof e == "string" && (e = Number(e)),
    typeof e == "number" && Number.isInteger(e) && e >= 0 ? e : null;
}
function Ii(s, e, t) {
  let { replacer: n } = t, i = new x(s);
...
var At = {
  ...
  Tt = {
    ...
    test: /^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,
    resolve(s) {
      let e = new S(parseFloat(s)), t = s.indexOf(".");
      return t !== -1 && s[s.length - 1] === "0" &&
...
var he = class extends x {
  ...
  toJSON(e, t) {
    ...
    for (let i of this.items) {
      let r, o;
      if (
        O(i) ? (r = M(i.key, "", t), o = M(i.value, r, t)) : r = M(i, "", t),
          n.has(r)
...
var on = {
  ...
  ln = {
    ...
    test: /^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,
    resolve(s) {
      let e = new S(parseFloat(s.replace(/_/g, ""))), t = s.indexOf(".");
      if (t !== -1) {
...
var pe = class extends $ {
  ...
  add(e) {
    ...
    O(e)
      ...
      ? t = new L(e.key, null)
      : t = new L(e, null), fe(this.items, t.key) || this.items.push(t);
  }
  get(e, t) {
...
function ms(s, e) {
  let t = s[0],
    ...
    r = n.replace(/_/g, "").split(":").reduce((o, a) => o * i(60) + i(a), i(0));
  return t === "-" ? i(-1) * r : r;
}
function pn(s) {
  let { value: e } = s, t = (o) => o;
  ...
  return e < 60
    ...
    n +
    r.map((o) => o < 10 ? "0" + String(o) : String(o)).join(":").replace(
      /000000\d*$/,
      "",
    );
}
...
var mn = new Map([["core", tn], ["failsafe", [W, H, ue]], ["json", nn], [
    "yaml11",
    ds,
  ], ["yaml-1.1", ds]]),
  dn = {
...
function xt(s, e) {
  ...
  if (!t) {
    if (Array.isArray(s)) t = [];
      ...
      let n = Array.from(mn.keys()).filter((i) => i !== "yaml11").map((i) =>
        JSON.stringify(i)
      ).join(", ");
      throw new Error(
  ...
  return t.map((n) => {
    ...
    let i = dn[n];
    if (i) return i;
    let r = Object.keys(dn).map((o) => JSON.stringify(o)).join(", ");
...
var Pi = (s, e) => s.key < e.key ? -1 : s.key > e.key ? 1 : 0,
  be = class {
    constructor(
      ...
      this.compat = Array.isArray(e) ? xt(e, "compat") : e ? xt(null, e) : null,
        this.merge = !!n,
        this.name = typeof r == "string" && r || "core",
        this.knownTags = i ? gn : {},
        this.tags = xt(t, this.name),
...
function yn(s, e) {
  ...
  if (s.contents) {
    ...
    let c = a ? void 0 : () => o = !0, f = Q(s.contents, i, () => a = null, c);
    a && (f += G(f, "", r(a))),
...
function Ae(s, e, t, n) {
  if (n && typeof n == "object") {
    ...
    } else {for (let [i, r] of Object.entries(n)) {
        let o = Ae(s, n, i, r);
...
var Z = class {
  constructor(e, t, n) {
    this.commentBefore = null,
      ...
      this.errors = [],
      this.warnings = [],
      Object.defineProperty(this, B, { value: ht });
    let i = null;
  ...
  clone() {
    let e = Object.create(Z.prototype, { [B]: { value: ht } });
  ...
  createPair(e, t, n = {}) {
    let i = this.createNode(e, null, n), r = this.createNode(t, null, n);
    return new L(i, r);
  }
  delete(e) {
  ...
  deleteIn(e) {
    return Ne(e)
      ? this.contents == null ? !1 : (this.contents = null, !0)
      : Ee(this.contents)
  ...
  getIn(e, t) {
    return Ne(e)
      ? !t && v(this.contents) ? this.contents.value : this.contents
      : T(this.contents)
  ...
  set(e, t) {
    this.contents == null
      ? this.contents = Be(this.schema, [e], t)
  ...
  setIn(e, t) {
    Ne(e)
      ? this.contents = t
      : this.contents == null
      ? this.contents = Be(this.schema, Array.from(e), t)
  ...
  toJS(
    ...
    if (typeof r == "function") {
      for (let { count: c, res: f } of a.anchors.values()) {
        r(f, c);
      }
    }
  ...
  toString(e = {}) {
    ...
    if (
      "indent" in e && (!Number.isInteger(e.indent) || Number(e.indent) <= 0)
    ) {
...
function ee(
  ...
  for (let k of s) {
    switch (
      p &&
      (k.type !== "space" && k.type !== "newline" && k.type !== "comma" &&
        r(
          k.offset,
          "MISSING_CHAR",
      ...
      case "space":
        !e && l && t !== "doc-start" && k.source[0] === "	" &&
        r(k, "TAB_AS_INDENT", "Tabs are not allowed as indentation"), c = !0;
        break;
      case "comment": {
        c ||
          r(
  ...
  let N = s[s.length - 1], b = N ? N.offset + N.source.length : i;
  return p && n && n.type !== "space" && n.type !== "newline" &&
    n.type !== "comma" && (n.type !== "scalar" || n.source !== "") &&
    r(
      n.offset,
      "MISSING_CHAR",
      "Tags and anchors must be separated from the next token by white space",
...
`)
      ...
      if (s.end) for (let e of s.end) if (e.type === "newline") return !0;
      return !1;
    case "flow-collection":
      for (let e of s.items) {
        for (let t of e.start) if (t.type === "newline") return !0;
        if (e.sep) for (let t of e.sep) if (t.type === "newline") return !0;
...
function We(s, e, t) {
  if ((e == null ? void 0 : e.type) === "flow-collection") {
    let n = e.end[0];
    n.indent === s && (n.source === "]" || n.source === "}") && me(e) &&
      t(
        n,
        "BAD_INDENT",
...
function jt(s, e, t) {
  ...
  if (n === !1) return !1;
  let i = typeof n == "function" ? n : (r, o) =>
    r === o ||
    v(r) && v(o) && r.value === o.value &&
...
` + p.comment
    ...
    } else {((r = p.found) === null || r === void 0 ? void 0 : r.indent) !==
    ...
    let m = p.end, d = f ? s(t, f, p, i) : e(t, m, c, null, p, i);
    ...
    if (a = y.end, y.found) {
      g &&
        ((h == null ? void 0 : h.type) === "block-map" && !y.hasNewline &&
          i(
            a,
            "BLOCK_AS_IMPLICIT_KEY",
            "Nested mappings are not allowed in compact mappings",
          ),
          t.options.strict && p.start < y.found.offset - 1024 &&
          i(
            d.range,
            "KEY_OVER_1024_CHARS",
...
function kn({ composeNode: s, composeEmptyNode: e }, t, n, i) {
  let r = n.start.source === "{",
    ...
    a = r ? new $(t.schema) : new x(t.schema);
  a.flow = !0;
  let l = t.atRoot;
  l && (t.atRoot = !1);
...
` + k
    ...
    if (!r && !w && !b.found) {
      ...
      let k = b.end, A = y ? s(t, y, b, i) : e(t, k, d, null, b, i);
      ...
      } else {N && ("source" in N && N.source && N.source[0] === ":"
...
` + j.comment
  ...
  if (h.length > 0) {
    ...
    g.comment && (a.comment
      ? a.comment += `
` + g.comment
      : a.comment = g.comment), a.range = [n.offset, p, g.offset];
...
function Nn(s, e, t, n, i) {
  ...
  if (!c) {
    ...
    } else {return i(n, "TAG_RESOLVE_FAILED", `Unresolved tag: ${o}`, !0),
        r.tag = o,
        r;}
  }
  let f = c.resolve(r, (h) => i(n, "TAG_RESOLVE_FAILED", h), e.options),
    u = E(f) ? f : new S(f);
  return u.range = r.range,
    u.tag = o,
    c != null && c.format && (u.format = c.format),
    u;
}
function Dt(s, e, t) {
  let n = s.offset, i = _i(s, e, t);
...
`.repeat(Math.max(0, o.length - 1))
        : "",
      d = n + i.length;
    return s.source && (d += s.source.length),
      { value: m, type: r, comment: i.comment, range: [n, d, d] };
  }
  let l = s.indent + i.indent, c = s.offset + i.length, f = 0;
  for (let m = 0; m < a; ++m) {
    let [d, y] = o[m];
    if (y === "" || y === "\r") {
...
function _i({ offset: s, props: e }, t, n) {
  ...
  let { source: i } = e[0], r = i[0], o = 0, a = "", l = -1;
...
function ws(s, e, t, n) {
  let { value: i, type: r, comment: o, range: a } = e.type === "block-scalar"
...
function Ss(s, e, t, n) {
  let { spaceBefore: i, comment: r, anchor: o, tag: a } = t, l;
  switch (e.type) {
    case "alias":
      l = Vi(s, e, n),
        (o || a) &&
...
function Vi({ options: s }, { offset: e, source: t, end: n }, i) {
  ...
  let o = e + t.length, a = te(n, o, s.strict, i);
  ...
  *next(e) {
    switch (e.type) {
      ...
      case "document": {
        ...
        this.atDirectives && !t.directives.marker &&
        this.onError(
          e,
          "MISSING_CHAR",
...
function Ns(s, e, t) {
  switch (s.type) {
    ...
    case "single-quoted-scalar":
      ...
      break;
    case "block-scalar": {
      let n = s.props.slice(1), i = e.length;
...
`,
    ...
    default: {
      let n = "indent" in s ? s.indent : -1,
        i = "end" in s && Array.isArray(s.end)
          ? s.end.filter((r) =>
            r.type === "space" || r.type === "comment" || r.type === "newline"
          )
          : [];
...
function de(s, e) {
  "type" in s && s.type === "document" &&
  (s = { start: s.start, value: s.value }), _n(Object.freeze([]), s, e);
}
de.BREAK = vs;
de.SKIP = Yi;
de.REMOVE = Pn;
...
var ze = "\uFEFF",
  ...
  Qi = (s) =>
    !!s &&
    (s.type === "scalar" || s.type === "single-quoted-scalar" ||
      s.type === "double-quoted-scalar" || s.type === "block-scalar");
function Wi(s) {
  switch (s) {
    case ze:
      return "<BOM>";
...
` || !i && !this.atEnd
        ...
        return t === `
` || n >= this.indentNext || !t && !this.atEnd
          ? e + n
          : -1;
      }
      if (t === "-" || t === ".") {
    ...
    getLine() {
      ...
      return (typeof e != "number" || e !== -1 && e < this.pos) &&
...
`,
          ...
          this.lineEndPos = e),
        e === -1
          ? this.atEnd ? this.buffer.substring(this.pos) : null
    ...
    *parseStream() {
      ...
      if (
        ...
        return yield* this.pushCount(e.length - i),
          this.pushNewline(),
          "stream";
      }
      if (this.atLineEnd()) {
    ...
    *parseLineStart() {
      ...
      return this.indentValue = yield* this.pushSpaces(!1),
        this.indentNext > this.indentValue && !K(this.charAt(1)) &&
...
` && i >= this.pos
    ...
    *parsePlainScalar() {
      let e = this.flowLevel > 0, t = this.pos - 1, n = this.pos - 1, i;
      for (; i = this.buffer[++n];) {
        if (i === ":") {
...
`
    ...
    *pushIndicators() {
      switch (this.charAt(0)) {
        case "!":
          return (yield* this.pushTag()) + (yield* this.pushSpaces(!0)) +
            (yield* this.pushIndicators());
        case "&":
          return (yield* this.pushUntil(As)) + (yield* this.pushSpaces(!0)) +
            (yield* this.pushIndicators());
        case ":":
        case "?":
        case "-":
...
`
    ...
    *pushSpaces(e) {
      let t = this.pos - 1, n;
      do n = this.buffer[++t]; while (n === " " || e && n === "	");
      let i = t - this.pos;
...
function xn(s) {
  if (s.start.type === "flow-seq-start") {
    for (let e of s.items) {
      e.sep && !e.value && !se(e.start, "explicit-key-ind") &&
      ...
      if (this.stack.length === 0) yield t;
        ...
        switch (
          t.type === "block-scalar"
            ...
            : t.type === "flow-collection" && n.type === "document" &&
              (t.indent = 0),
            t.type === "flow-collection" && xn(t),
            n.type
        ) {
          case "document":
            n.value = t;
        ...
        if (
          (n.type === "document" || n.type === "block-map" ||
            n.type === "block-seq") &&
          (t.type === "block-map" || t.type === "block-seq")
        ) {
          let i = t.items[t.items.length - 1];
          i && !i.sep && !i.value && i.start.length > 0 && !Es(i.start) &&
            (t.indent === 0 ||
              i.start.every((r) =>
                r.type !== "comment" || r.indent < t.indent
              )) &&
            (n.type === "document"
              ? n.end = i.start
...
`,
        ...
        if (n.value) e.items.push({ start: [this.sourceToken] });
          ...
          if (this.atIndentedComment(n.start, e.indent)) {
            let i = e.items[e.items.length - 2],
              r = (t = i == null ? void 0 : i.value) === null || t === void 0
                ? void 0
                : t.end;
            if (Array.isArray(r)) {
      ...
      switch (this.type) {
        ...
        case "map-value-ind":
          if (!n.sep) Object.assign(n, { key: null, sep: [this.sourceToken] });
            ...
            se(n.start, "explicit-key-ind") && jn(n.key) &&
            !se(n.sep, "newline")
          ) {
            let r = it(n.start), o = n.key, a = n.sep;
        ...
        default: {
          ...
          if (r) {
            i && r.type !== "block-seq" && se(n.start, "explicit-key-ind") &&
            e.items.push({ start: [] }), this.stack.push(r);
            return;
          }
        }
      }
  ...
  *flowCollection(e) {
    ...
    if (this.type === "flow-error-end") {
      let n;
      do yield* this.pop(), n = this.peek(1); while (
        n && n.type === "flow-collection"
      );
...
function Ts(s, e = {}) {
  ...
  return n && t && (o.errors.forEach(gs(s, t)), o.warnings.forEach(gs(s, t))),
    o;
}
var Ut = class {
  constructor(e, t, n, i) {
  ...
  async renamed(e) {
    let t = this.app.vault.getAbstractFileByPath(this.filename),
      ...
      i = n;
    for (let { position: { start: r, end: o }, tag: a } of this.tagPositions) {
    ...
    function c(f, u) {
      ...
      if (!(!p || !p.length)) {
        if (typeof p == "string") {
          ...
          p != m && l(h, m, !0);
        } else {Array.isArray(p) && t.inArray(p, !1, u).forEach((g, m) => {
            p[m] !== g && l(h.get(m, !0), g);
          });}
      }
    }
    for (let { key: { value: f } } of r.contents.items) {
...
async function qn(s, e) {
  ...
  let l = await Is(s, n);
  if (!l) return;
  let c = new _e(`Renaming to #${t}/*`, "Processing files..."), f = 0;
  return await c.forEach(l, async (u) => {
...
async function Is(s, e) {
  let t = [], n = new _e(`Searching for ${e}/*`, "Matching files...");
  if (
    await n.forEach(s.metadataCache.getCachedFiles(), (i) => {
      ...
      let a = ((0, we.parseFrontMatterTags)(r) || []).filter(e.matches),
        l = ((0, we.parseFrontMatterAliases)(r) || []).filter(I.isTag).filter(
          e.matches,
        );
  ...
  try {
    await (0, Dn.confirm)(
      ...
      `Renaming <code>${t}</code> to <code>${n}</code> will merge ${
        s.canonical === t.canonical ? "these tags" : `multiple tags
...
function nr(s, e, t) {
  let n = s[e], i = s.hasOwnProperty(e), r = t(n);
  return n && Object.setPrototypeOf(r, n),
...
`),
  ...
  async onload() {
    this.register(
      ...
      this.addChild(
        new at(this, {
          ...
          toTag(i) {
            var r;
            return (r = i.find(".tag-pane-tag-text")) == null
              ? void 0
              : r.textContent;
          },
        }),
      ...
      this.register(ot(document, "pointerdown", ".tag-pane-tag", (i, r) => {
        r.draggable = "true";
      }, { capture: !0 })),
      this.register(ot(document, "dragstart", ".tag-pane-tag", (i, r) => {
        var a;
        let o = (a = r.find(".tag-pane-tag-text")) == null
          ? void 0
          : a.textContent;
    ...
    let t = this.app.metadataCache, n = this;
    this.register(Fn(t, {
      getTags(i) {
        return function () {
          let o = i.call(this),
      ...
      this.app.workspace.onLayoutReady(() => {
        t.getCachedFiles().forEach((i) => {
          ...
          r && ((a = (0, P.parseFrontMatterAliases)(r)) == null
            ? void 0
            : a.filter(I.isTag)) &&
  ...
  updatePage(t, n) {
    ...
    if (this.pageAliases.has(t)) {
      ...
      for (let a of this.pageAliases.get(t)) {
        if (o.has(a)) continue;
        let l = I.canonical(a), c = this.tagPages.get(l);
  ...
  onMenu(t, n) {
    ...
    let i = n.find(".tag-pane-tag-text").textContent,
      r = this.tagPage(i),
    ...
    if (
      u.addSeparator(),
        r
          ? u.addItem(
            le(
              "popup-open",
              "Open tag page",
              (h) => this.openTagPage(r, !1, P.Keymap.isModEvent(h)),
            ),
          )
          : u.addItem(
            le(
              "create-new",
              "Create tag page",
              (h) => this.createTagPage(i, P.Keymap.isModEvent(h)),
            ),
          ),
        l &&
        ...
        f &&
        u.addSeparator().addItem(le("dice", "Open random note", async () => {
      ...
      let m = function (d) {
          for (let y of g.children) y.setCollapsed(d);
        },
  ...
  leafView(t) {
    let n;
    return this.app.workspace.iterateAllLeaves((i) => {
...
var at = class extends P.Component {
  ...
  onload() {
    ...
    this.register(ot(document, "mouseover", e, (r, o) => {
      let a = i(o), l = a && this.plugin.tagPage(a);
      l &&
      ...
      this.register(ot(document, "click", e, (r, o) => {
        let { altKey: a } = r;
        if (!P.Keymap.isModEvent(r) && !a) return;
        let l = i(o), c = l && this.plugin.tagPage(l);
        if (c) {
          return this.plugin.openTagPage(c, !1, !a),
            r.preventDefault(),
            r.stopPropagation(),
            !1;
        }
