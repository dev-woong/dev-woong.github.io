...
## Texture Asset
![Texture Asset](../../GitHub/Github%20Apps%20세부%20설정%20및%20생성/1.png)

### 이미지 분할과 POT(Power of Two) 규격
#### 하나의 이미지 에셋에 여러 장의 그림을 그리고 분할하여 사용하는 이유
![이미지 크기에 따른 메모리 POT 공간 비교](../../GitHub/Github%20Apps%20세부%20설정%20및%20생성/2.png)
![유사한 성격의 이미지를 모아서 제작된 POT 규격 이미지](../../GitHub/Github%20Apps%20세부%20설정%20및%20생성/3.png)
