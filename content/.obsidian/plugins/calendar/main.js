...
function appHasPeriodicNotesPluginLoaded() {
  ...
  return periodicNotes &&
    ((_b = (_a = periodicNotes.settings) === null || _a === void 0
            ? void 0
...
function create_if_block$1(ctx) {
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      if (
        dirty & /*metadata*/ 1 && promise !== (promise = /*metadata*/ ctx[0]) &&
...
function create_fragment$4(ctx) {
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (
        dirty & /*$$scope, metadata, selectedId, date, displayedMonth, today, onClick, onContextMenu, onHover*/
        16639
      ) {
...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (
        dirty & /*$$scope, metadata, selectedId, days, onClick, startOfWeek, onContextMenu, onHover, weekNum*/
        16639
      ) {
        metadataresolver_changes.$$scope = { dirty, ctx };
      }
  ...
  return {
    ...
    p(ctx, dirty) {
      const weeknum_changes =
        (dirty & /*month, getWeeklyMetadata, sources, today, onClickWeek, onContextMenuWeek, onHoverWeek, selectedId*/
            18344)
...
function create_each_block(key_1, ctx) {
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      if (
        dirty & /*month, today, displayedMonth, onClickDay, onContextMenuDay, onHoverDay, getDailyMetadata, sources, selectedId*/
        18261
      ) {
...
function create_fragment$7(ctx) {
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (
        dirty & /*month, today, displayedMonth, onClickDay, onContextMenuDay, onHoverDay, getDailyMetadata, sources, selectedId, getWeeklyMetadata, onClickWeek, onContextMenuWeek, onHoverWeek, showWeekNums*/
        18431
      ) {
...
function configureGlobalMomentLocale(
  ...
  const systemLang = (_a = navigator.language) === null || _a === void 0
    ? void 0
    : _a.toLowerCase();
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe(
    $$self,
    settings,
    ($$value) => $$invalidate(8, $settings = $$value),
  );
  component_subscribe(
    $$self,
    activeFile,
    ($$value) => $$invalidate(10, $activeFile = $$value),
  );
  ...
  async onload() {
    ...
    this.addCommand({
      ...
      checkCallback: (checking) => {
        if (checking) {
          return (this.app.workspace.getLeavesOfType(VIEW_TYPE_CALENDAR)
            .length === 0);
        }
        this.initLeaf();
      },
