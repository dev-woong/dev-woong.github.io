...
function scrollToTocElement(
  ...
  let scrollTop = tocElement.offsetTop - scrollableNavigation.offsetHeight / 2 +
    textHeight / 2 - scrollableNavigation.offsetTop;
  if (scrollTop < 0) {
    scrollTop = 0;
  }
...
function setupScrollspy() {
  ...
  let idToNavigationElement: IdToElementMap = buildIdToNavigationElementMap(
    navigation,
  );
