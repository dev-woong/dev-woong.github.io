...
class s extends e.PluginSettingTab {
  ...
  display() {
    ...
    t.empty(),
      ...
      new e.Setting(t).setName("Ribbon Icon").setDesc(
        "Turn on if you want Ribbon Icon for clearing the images.",
      ).addToggle((e) =>
      ...
      new e.Setting(t).setName("Delete Logs").setDesc(
      ...
      new e.Setting(t).setName("Deleted Image Destination").setDesc(
      ...
      new e.Setting(t).setName("Excluded Folder Full Paths").setDesc(
      ...
      new e.Setting(t).setName("Exclude Subfolders").setDesc(
...
const a = (e, i, s) =>
    t(void 0, void 0, void 0, function* () {
      ...
      if (n) {
        ...
        for (let a of n) {
          if (h(a)) {
            let s = u(a), n = i.metadataCache.getFirstLinkpathDest(s, e.path);
            if ("" !== s) {
              let i = {
      ...
      if (a) {
        ...
        for (let n of a) {
          if (c(n)) {
            let s = u(n), a = i.metadataCache.getFirstLinkpathDest(s, e.path);
            if ("" !== s) {
              let i = {
                type: "mdTransclusion",
                match: n,
  ...
  v = (e) =>
    t(void 0, void 0, void 0, function* () {
      var t = new Set(), i = e.metadataCache.resolvedLinks;
      if (i) {
      ...
      for (let i = 0; i < s.length; i++) {
        ...
        if ("md" === n.extension) {
          ...
          let i = yield e.vault.cachedRead(n), s = JSON.parse(i);
  ...
  b = (e) => e.match(g),
  x = (e, t) => {
    var i = t.settings.excludedFolders, s = t.settings.excludeSubfolders;
    if ("" === i) return !1;
          ...
          if (l.length > 0) {
            ...
            e += `[+] ${y()}: Clearing started.</br>`,
              (s = l,
                ...
                o = this.app,
                t(void 0, void 0, void 0, function* () {
                  var e = a.settings.deleteOption, t = 0;
                  let i = "";
                  for (let n of s) {
                    x(n, a)
                      ? console.log(
                        "File not referenced but excluded: " + n.path,
                      )
                      : (".trash" === e
                        ? (yield o.vault.trash(n, !1),
                          i += "[+] Moved to Obsidian Trash: " + n.path +
                            "</br>")
                        : "system-trash" === e
                        ? (yield o.vault.trash(n, !0),
                          i += "[+] Moved to System Trash: " + n.path + "</br>")
                        : "permanent" === e &&
                          (yield o.vault.delete(n),
                            i += "[+] Deleted Permanently: " + n.path +
                              "</br>"),
                        t++);
                  }
              ...
              `All ${
                "image" === i ? "images" : "attachments"
              } are used. Nothing was deleted.`,
            );}
        });
  }
  onload() {
